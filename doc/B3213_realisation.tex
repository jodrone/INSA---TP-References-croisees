...
\lstinputlisting{../src/tests/testA1.cpp}
\lstinputlisting{../src/tests/testA1.h}
\lstinputlisting{../src/tests/keywords.txt}
...
\subsubsection{Fichiers :}
\lstinputlisting{../src/fichiers/test1.cpp}
\lstinputlisting{../src/fichiers/motsClesCpp.txt}
\lstinputlisting{../src/fichiers/test2.txt}
\newpage
